...
public class SmtpSetController {

    @GetMapping("/smtpSet") // 메일 서버 설정
    public String smtpSet(HttpServletResponse response, HttpServletRequest request, Model model) throws Exception {

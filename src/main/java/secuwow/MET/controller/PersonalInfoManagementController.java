...
public class PersonalInfoManagementController {
    ...
    @GetMapping("/personalInfoManagement") // 개인정보 관리
    public String personalInfoManagement(HttpServletResponse response, HttpServletRequest request, Model model) throws Exception {
